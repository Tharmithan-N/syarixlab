          ...
          {reasons.map((reason, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 border border-gray-100 flex flex-col items-start text-left transition-transform duration-500 ease-out cursor-pointer"
              >
                <div className="p-3 bg-gradient-to-tr from-[#47919F]/20 to-[#3C7E8A]/20 rounded-xl mb-4 text-[#47919F]">
                  <Icon className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  {reason.title}
