    ...
    <section className="bg-[#fafaff] py-20" id={id}>
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          className="text-gray-500 max-w-2xl mx-auto mb-12"
        >
          We create modern, responsive, and visually stunning projects for businesses and individuals.
        </motion.p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              {/* Hover Mask */}
              <div className="absolute inset-0 bg-[#47919F]/30 opacity-0 group-hover:opacity-60 translate-y-full group-hover:translate-y-0 transition-all duration-700 ease-out" />
              ...
              <div className="absolute bottom-6 left-6 right-6 transition-all duration-500 group-hover:translate-y-[-10px] z-10 text-center">
                ...
                <button className="px-4 py-2 bg-[#47919F] text-white text-sm font-medium rounded-md hover:bg-[#3C7E8A] transition-colors duration-300">
                  View Project
                </button>
              </div>
            </motion.div>
        ...
        <motion.button
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="px-8 py-3 bg-[#47919F] text-white font-semibold rounded-full hover:bg-[#3C7E8A] transition-colors duration-300 mt-10 cursor-pointer"
        >
          View More
        </motion.button>
      </div>
