...
export default function LatestNewsSection({ id }: { id?: string }) {
  return (
    <section className="bg-[#fafaff] py-20" id={id}>
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          className="text-gray-500 max-w-2xl mx-auto mb-12"
        >
          Stay updated with our latest updates, insights, and announcements.
        </motion.p>
          ...
          {news.map((item, index) => (
            ...
            >
              ...
              <div className="relative w-full h-56 sm:h-64 md:h-72 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 hover:opacity-30 transition-opacity duration-500" />
              </div>
