...
// export default function DigitalMarketingSection({id} : {id: string}) {
//   return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed max-w-lg">
            We deliver creative, data-driven marketing strategies that boost reach, engagement, and business growth.
          </p>
