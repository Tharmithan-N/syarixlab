...
// export default function WebDesignSection({id}: {id?: string}) {
//   return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        >
          ...
          {/* <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.97 }}
            className="mt-6 px-8 py-3 bg-gradient-to-r from-[#47919F] to-[#3C7E8A] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
          >
            READ MORE
          </motion.button> */}
        </motion.div>
